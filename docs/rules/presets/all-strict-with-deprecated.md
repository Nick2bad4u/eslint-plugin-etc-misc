---
title: All Strict With Deprecated preset
---

# 🔴⚠️ All Strict With Deprecated

Use this migration preset when you need strict enforcement of every current
rule while temporarily retaining deprecated rules without same-plugin
replacements as warnings.
...
- The 12 deprecated rules with same-plugin replacements remain manually
  configurable but are excluded to prevent duplicate execution.
...
- [`etc-misc/no-unstable-react-children`](../no-unstable-react-children.md) (R159)
- [`etc-misc/no-unstable-react-values`](../no-unstable-react-values.md) (R158)
...
Prefer `allStrict` for new configurations. Use this preset only as a temporary
migration bridge while removing deprecated rules before their documented
removal release.

## Related pages

- [All Strict](./all-strict.md)
- [All With Deprecated](./all-with-deprecated.md)
