---
title: All With Deprecated preset
---

# 🟣⚠️ All With Deprecated

Use this migration preset only when you intentionally need every current rule
plus deprecated rules that do not have same-plugin replacements.
...
Prefer `all` for new configurations. Use this preset only as a temporary
...
- [All](./all.md)
- [All Strict With Deprecated](./all-strict-with-deprecated.md)
