    ...
    ruleCreator<Options, MessageIds>({
        ...
        meta: {
            docs: {
                ...
                recommended: false,
                url: "https://github.com/Nick2bad4u/eslint-plugin-etc-misc/blob/main/docs/rules/no-unnecessary-break.md",
            },
            hasSuggestions: false,
            messages: {
                forbidden: "Unnecessary break statement at end of switch case list.",
            },
            schema: [],
            type: "suggestion",
        },
