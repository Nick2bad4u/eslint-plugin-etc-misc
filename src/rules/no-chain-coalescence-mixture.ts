...
const disallowedSelector = "LogicalExpression[operator='??'][left.type='ChainExpression']";

/**
 * Disallow mixing optional chaining expressions directly with nullish coalescing.
 */
