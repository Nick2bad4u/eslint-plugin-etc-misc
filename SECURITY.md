...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-etc-misc/security/advisories/new>
...
- Keep `eslint-plugin-etc-misc`, ESLint, TypeScript, and dependencies updated.
